...
module.exports = {
  ...
  // A map from regular expressions to module names that allow to stub out resources with a
  // single module moduleNameMapper: {},
  ...
  // the testing environment before each test setupFiles: [],

  // A list of paths to modules that run some code to configure or set up
  // the testing framework before each test setupFilesAfterEnv: [],
  ...
  // all test paths, matched tests are skipped testPathIgnorePatterns: [
  //   "/node_modules/"
  // ],
  ...
  // file paths, matched files will skip transformation transformIgnorePatterns: [
  //   "/node_modules/"
  // ],
